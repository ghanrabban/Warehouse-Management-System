...
SECRET_KEY = 'django-insecure-6^$g-sg5lffo1pwoarbt4vd#!a2m1y@dpl&%g38dltb3voj$$r'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME',     'wms_demo'),
        'USER': os.environ.get('DB_USER',     'wms_user'),
        'PASSWORD': os.environ.get('DB_PASS', 'wms_pass'),
